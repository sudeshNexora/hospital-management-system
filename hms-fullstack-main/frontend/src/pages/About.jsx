    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-lg text-gray-600">
          <p>
            Welcome to SDM Hospital Ujire, your trusted partner in managing
            your healthcare needs conveniently and efficiently. We understand
            the challenges individuals face when it comes to scheduling
            doctor appointments and managing their health records.
          </p>
          <p>
            SDM Hospital Ujire is committed to excellence in healthcare and
            healthcare technology. We continuously strive to enhance our
            platform, integrating the latest advancements to improve patient
            experience and deliver superior service. Whether you're booking
            your first appointment or managing ongoing care, we're here to
            support you every step of the way.
          </p>
          <strong className="text-gray-800">Our Vision</strong>
          <p>
            Our vision at SDM Hospital Ujire is to create a seamless
            healthcare experience for every patient. We aim to bridge the gap
